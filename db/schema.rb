...
ActiveRecord::Schema.define(:version => 20130125233618) do
  ...
  create_table "game_rules", :force => true do |t|
    ...
    t.string   "game_type",    :default => "normal"
  end
  ...
  create_table "season_scores", :force => true do |t|
    t.integer  "user_id"
    t.integer  "points"
    t.integer  "season_id"
    t.datetime "created_at", :null => false
  ...
  add_index "time_series", ["created_at"], :name => "index_time_series_on_created_at"
  add_index "time_series", ["key"], :name => "index_time_series_on_key"
  add_index "time_series", ["name"], :name => "index_time_series_on_name"
